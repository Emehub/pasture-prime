        ...
        >
          {CONTACT_CARDS.map((c, i) => {
            ...
            return (
              <div
                key={c.title}
                className="relative px-8 py-10 text-center border-b sm:border-r border-bgray-100 last:border-0 group overflow-hidden"
                style={{
                  opacity: cardsIn ? 1 : 0,
            ...
            <div className="flex flex-col gap-2.5 mb-10">
              {ENQUIRY_TYPES.map((e) => {
                ...
                return (
                  ...
                  >
                    <div className="w-9 h-9 bg-green-pale rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:bg-green-mid transition-colors">
          ...
          >
            <div className="bg-white rounded-2xl p-10 shadow-lg border border-bgray-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2.5 px-8 py-4 bg-green-mid text-white rounded-lg font-semibold text-[0.93rem] hover:bg-green-dark transition-all hover:-translate-y-0.5 shadow-md"
                >
              ...
              >
                ...
                >
                  ...
                  <FaPlus
                    size={13}
                    color="#2d6a2d"
                    className={`flex-shrink-0 ml-4 transition-transform duration-300 ${openFaq === i ? 'rotate-45' : ''}`}
                  />
                </button>
                <div
                  style={{
